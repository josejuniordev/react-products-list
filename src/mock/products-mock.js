export const productsMock = [
  ...
  {
    'id': 7,
    'nome': 'Patinete Elétrico XPTO',
    'valor': 5698.00,
    'exclusivo': true,
    'promocao': false,
    'imagem': 'https://i.imgur.com/GhVWPQj.jpg',
    'decricaoCurta': 'É uma verdadeira ferramenta para a revolução do transporte pessoal!',
    'descricaoLonga': 'Existem diversas maneiras de andar pela cidade. Os nossos preferidos são os práticos, baratos, ecológicos e divertidos. Pensando nisso oferecemos a tecnologia para atender a pessoas das mais variadas idades. O Patinete é ideal para mobilidade nos grandes centros urbanos. Sua bateria de Lítio é leve e tem um carregamento rápido que proporciona ao veículo uma autonomia de até 30 km. O Patinete atinge velocidade de 25Km/h para que você chegue rápido em seus compromissos. Seu chassi construído em alumínio é leve e resistente, e a haste do guidão é dobrável para possibilitar um melhor transporte. O Patinete vem equipado com campainha, farol, lanterna e luz de alerta de freio em led para que passeios noturnos fiquem mais seguros.',
    'fichaTecnica': [
      {
  ...
  },
  {
    ...
    'fichaTecnica': [
      ...
      {
        'titulo': 'Dimensões do aparelho',
        'descricao': '23 x 9,5 x 11cm'
      },
      {
        'titulo': 'Garantia',
        'descricao': '2 anos de fábrica'
      },
      {
